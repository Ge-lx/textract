        ...
        else if (92 === c)
        {
                ...
                if (1 === len)
                {
                        ...
                        if (39 === c)
                        {
                                ...
                                var str = String.fromCodePoint('0x'+ d1.toString(16) + d2.toString(16) )
                                return NewRtfTk(RtfConst().CHARACTER, 4, str.codePointAt(0));
...
function RtfTkChr(t, s, i)
{
        ...
        return String.fromCodePoint(((t >> 15) & 0xFFFF));
}
        ...
        function RtfParser__Document(incomplete)
        {
                ...
                for ( ; this.pos < this.txt.length; this.pos += len)
                {
                        ...
                        if (2 === typ)
                        {
                                ...
                                // ignorable destination marker CHANGED TO TRUE
                                var ign = true;
                                if (4 === typ)
                                {
                                        ign = true;
                                ...
                                // token MUST be control word (REMOVED. CAUSED Error)
                                // if (6 !== typ)
...
module.exports = function(txt, baseurl, out, ver)
{
        ...
        //parser.HandleDest(";rtf;info;printim", parser.HandleIgnore);
